...
namespace BugTracker1.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,Description,Created,UserId,FileUrl")] TicketAttachments ticketAttachments, HttpPostedFileBase file)
        {
            if (ModelState.IsValid)
            {
                if (FileUploadValidator.IsWebFriendlyImage(file))
                {
                    ...
                    ticketAttachments.FileUrl = "/images/" + fileName;
                }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,Description,Created,UserId,FileUrl")] TicketAttachments ticketAttachments)
        {
            if (ModelState.IsValid)
            {
